...
@test "update of a group with a new subject and context adds a row" {
    ...
    executionMarker --timestamp "$NOW" --group "$BATS_TEST_NAME" --update "quux" --context "More inforatiom for this"
    assert_config_row "$BATS_TEST_NAME" \$ "quux	$NOW	More inforatiom for this"
}
