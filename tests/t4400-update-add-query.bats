...
@test "update of a group with a new subject and context adds a row and returns an empty previous context" {
...
@test "update of a group with a new subject and context adds a row and returns an empty previous timestamp" {
    initialize_config "$BATS_TEST_NAME" from samples
...
@test "update of a group with a new subject and context adds a row and returns an empty previous context and timestamp" {
    initialize_config "$BATS_TEST_NAME" from samples
